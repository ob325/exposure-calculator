...
var len__4531__auto___10336 = arguments.length;
var i__4532__auto___10337 = (0);
while(true){
if((i__4532__auto___10337 < len__4531__auto___10336)){
args__4534__auto__.push((arguments[i__4532__auto___10337]));

var G__10338 = (i__4532__auto___10337 + (1));
i__4532__auto___10337 = G__10338;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq10333){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10334,G__10335,seq10333__$2);
});
...
var vec__10339 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__10339,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__10339,(1),null);
var G__10342 = cljs.core.PersistentArrayMap.EMPTY;
var G__10342__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__10342,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10342);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__10342__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__10342__$1;
}
} else {
...
return (function() { 
var G__10346__delegate = function (klass,contents){
var vec__10343 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__10343,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__10343,(1),null);
...
var G__10346 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__10347__i = 0, G__10347__a = new Array(arguments.length -  1);
while (G__10347__i < G__10347__a.length) {G__10347__a[G__10347__i] = arguments[G__10347__i + 1]; ++G__10347__i;}
  contents = new cljs.core.IndexedSeq(G__10347__a,0,null);
} 
return G__10346__delegate.call(this,klass,contents);};
G__10346.cljs$lang$maxFixedArity = 1;
G__10346.cljs$lang$applyTo = (function (arglist__10348){
var klass = cljs.core.first(arglist__10348);
var contents = cljs.core.rest(arglist__10348);
return G__10346__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__10352){
var map__10353 = p__10352;
var map__10353__$1 = ((((!((map__10353 == null)))?(((((map__10353.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10353.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10353):map__10353);
var ns = cljs.core.get.call(null,map__10353__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__10353__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__10355){
...
var actual = cljs.core.get.call(null,map__10356__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__10356__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__10358){
var map__10359 = p__10358;
var map__10359__$1 = ((((!((map__10359 == null)))?(((((map__10359.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10359.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10359):map__10359);
var expected = cljs.core.get.call(null,map__10359__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__10359__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__10361_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__10363 = cljs_test_display.core.current_var_info.call(null);
var map__10363__$1 = ((((!((map__10363 == null)))?(((((map__10363.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10363.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10363):map__10363);
var info = map__10363__$1;
var name = cljs.core.get.call(null,map__10363__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__10363__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10363__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__10363,map__10363__$1,info,name,line,file,node){
return (function (p1__10362_SHARP_){
return cljs.core.cons.call(null,node,p1__10362_SHARP_);
});})(curr_node,map__10363,map__10363__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__10365){
var map__10366 = p__10365;
...
var m = map__10366__$1;
var fail = cljs.core.get.call(null,map__10366__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__10366__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__10366__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__10366__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___10368 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10368)){
var message_10369 = temp__5457__auto___10368;
cljs.core.println.call(null,message_10369);
} else {
}
...
var temp__5457__auto___10370 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10370)){
var message_10371 = temp__5457__auto___10370;
cljs.core.println.call(null,message_10371);
} else {
}
