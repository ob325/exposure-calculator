...
return html_coll.item(p1__10307_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__10308_SHARP_);
...
var ctx_10309 = cvs.getContext("2d");
ctx_10309.fillStyle = color;

ctx_10309.fillRect((0),(0),size,size);
